...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cashiers', function (Blueprint $table) {
            ...
            $table->decimal('papers_total', 20,7)->nullable();
            $table->decimal('coins_total', 20,7)->nullable();
            $table->decimal('total', 20,7)->nullable();
            $table->json('papers_qty')->nullable();
            $table->json('coins_qty')->nullable();
            $table->decimal('end_papers_total', 20,7)->nullable();
            $table->decimal('end_coins_total', 20,7)->nullable();
            $table->decimal('end_total', 20,7)->nullable();
