...
class CreatePurchasingOrderReceivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchasing_order_receives', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('purchasing_order_receives');
    }
}
