            ...
            */
            $('button[name=simpan]').on('click', function () {
                ...
                if(startDate != '' && endDate != ''){
                    ...
                    $.ajax({
                      ...
                      url: '{{ route('report.sales_report.ajax_get_sales_report') }}',
                      data: { 
                              startDate: startDate,
                              endDate: endDate,
                            },
            ...
            $('body').on('click', '.m-tabs__link' , function(){
                ...
                if(href == '#tab_cashier'){
                    ...
                    routePDF = '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'cashier', 'file' => 'pdf', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';
                    routeXLS =  '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'cashier', 'file' => 'xls', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';


                } else if(href == '#tab_transaction'){

                    routePDF = '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'transaction', 'file' => 'pdf', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';
                    routeXLS =  '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'transaction', 'file' => 'xls', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';

                } else if(href == '#tab_product'){

                    routePDF = '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'product', 'file' => 'pdf', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';
                    routeXLS =  '{{ route('report.sales_report.ajax_generate_sales_report', ['type' => 'product', 'file' => 'xls', 'startDate' => 'startDate', 'endDate' => 'endDate']) }}';
