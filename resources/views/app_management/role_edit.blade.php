@extends('layouts.base')
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $role->id], 'id' => 'role_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('description') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::textarea('description', $role->description, ['class' => 'form-control', 'size' => '-x-']) }}
    ...
    {!! JsValidator::formRequest('App\Http\Requests\app_management\RoleRequest', '#role_edit') !!}
