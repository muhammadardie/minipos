@extends('layouts.base')
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => $route_store, 'id' => 'role_create', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-lg-5 col-sm-12">
                                {{ Form::textarea('description', '', ['class' => 'form-control', 'size' => '-x-']) }}
    ...
    {!! JsValidator::formRequest('App\Http\Requests\app_management\RoleRequest', '#role_create') !!}
            ...
            $(document).ready(function(){
                ...
                */
                $('#role_create').on('submit', function (e) {
                    // form is valid
                    is_form_valid = $('#role_create').valid();
