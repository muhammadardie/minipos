                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-5 col-sm-12" style="margin-top: 10px">
                                @if($purchase_orders->approved === true)
                                    <span class="m-badge m-badge--success m-badge--wide m-badge--rounded">Received</span> 
                                @elseif($purchase_orders->approved === false)
                                    <span class="m-badge m-badge--danger m-badge--wide m-badge--rounded">Returned</span>
                                @else
                                    <span class="m-badge m-badge--info m-badge--wide m-badge--rounded">Waiting</span>
                                @endif
                            </div>
                        </div>   
                    </div>
