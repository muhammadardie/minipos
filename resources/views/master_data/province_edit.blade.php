        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $province->id], 'id' => 'province_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\ProvinceRequest', '#province_edit') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#province_edit').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#province_edit').valid();
