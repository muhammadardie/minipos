        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $discount_type->id], 'id' => 'discount_type_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::text('name', $discount_type->name, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('remark') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::textarea('remark', $discount_type->remark, ['class' => 'form-control']) }}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\Discount_typeRequest', '#discount_type_edit') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#discount_type_edit').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#discount_type_edit').valid();
