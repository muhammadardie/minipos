@extends('layouts.base')
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                            ...
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">
                                    @if(array_key_exists('create', $list_permission))
                                        <a class="btn btn-primary" href="{{ route($route_create) }}"><i class="fa fa-plus"></i> Add Discount Type</a>
                                    @endif
                                </h3>
                            </div>          
                        </div>
                    ...
                    <div class="table-responsive pos-table" data-delete-url="{{ $route_destroy }}" data-remark="discount_type">
                        <table class="table table-striped- table-bordered table-hover" id="discount_type-table">
                            <thead>
                                <tr>
                                    <th width="10px">No</th>
    ...
    $(function() {
        var t = $('#discount_type-table').DataTable({
            processing: true,
            serverSide: true,
        ...
        $('div#discount_type-table_length.dataTables_length').css("margin-bottom", "10px");
    });
