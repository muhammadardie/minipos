        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $shift->id], 'id' => 'shift_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::text('name', $shift->name, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('start_time') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::text('start_time', $shift->start_time, ['class' => 'form-control m_timepicker', 'readonly']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('end_time') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::text('end_time', $shift->end_time, ['class' => 'form-control m_timepicker']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('remark') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::textarea('remark', $shift->remark, ['class' => 'form-control']) }}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\ShiftRequest', '#shift_edit') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#shift_edit').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#shift_edit').valid();
