        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => $route_store, 'id' => 'product_category_create', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\Product_categoryRequest', '#product_category_create') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#product_category_create').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#product_category_create').valid();
