@extends('layouts.base')
        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                            ...
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">
                                    @if(array_key_exists('create', $list_permission))
                                        <a class="btn btn-primary" href="{{ route($route_create) }}"><i class="fa fa-plus"></i> Add Brand</a>
                                    @endif
                                </h3>
                            </div>          
                        </div>
                    ...
                    <div class="table-responsive pos-table" data-delete-url="{{ $route_destroy }}" data-remark="brand">
    ...
    $(function() {
        ...
        $('div#brand-table_length.dataTables_length').css("margin-bottom", "10px");
    });
