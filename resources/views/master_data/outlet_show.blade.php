                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <input type="text" class="form-control" value="{{ $outlet->district->regency->province->name }} "disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-lg-2 col-sm-12">Regency</label>
                                <div class="col-lg-6 col-sm-12">
                                    <input type="text" class="form-control" value="{{ $outlet->district->regency->name }} "disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-lg-2 col-sm-12">District</label>
                                <div class="col-lg-6 col-sm-12">
                                    <input type="text" class="form-control" value="{{ $outlet->district->name }} "disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-lg-2 col-sm-12">Name</label>
                                <div class="col-lg-6 col-sm-12">
                                    <input type="text" class="form-control" value="{{ $outlet->name }} "disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-lg-2 col-sm-12">Description</label>
                                <div class="col-lg-6 col-sm-12">
                                    <textarea class="form-control" rows="4" cols="50" disabled>{{ $outlet->description }}</textarea>
                                </div>
                            </div>
                        </div>
