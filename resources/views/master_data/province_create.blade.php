        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => $route_store, 'id' => 'province_create', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\ProvinceRequest', '#province_create') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#province_create').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#province_create').valid();
