        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $outlet->id], 'id' => 'outlet_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row {{ $errors->has('province') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::select('province', $province, $outlet->district->regency->province_id, ['class' => 'form-control select2']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('regency') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::select('regency', $regency, $outlet->district->regency_id, ['class' => 'form-control select2']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('district') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::select('district', $district, $outlet->district_id, ['class' => 'form-control select2']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::text('name', $outlet->name, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('description') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::textarea('description', $outlet->description, ['class' => 'form-control']) }}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\OutletRequest', '#outlet_edit') !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            */
            $('#outlet_edit').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#outlet_edit').valid();
