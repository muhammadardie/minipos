                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <input type="text" class="form-control" value="{{ $product_category->name }} "disabled>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-lg-2 col-sm-12">Remark</label>
                                <div class="col-lg-6 col-sm-12">
                                    <textarea class="form-control" rows="4" cols="50" disabled>{{ $product_category->remark }}</textarea>
                                </div>
                            </div>
                        </div>
