        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => $route_store, 'id' => 'product_create', 'class' => 'm-form m-form--fit m-form--label-align-left', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('product_category') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                {{ Form::select('product_category', $product_category, null, ['class' => 'form-control select2']) }}
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('product_category') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                {{ Form::select('brand', $brand, null, ['class' => 'form-control select2']) }}
                                                {!! $errors->first('outlet', '<span class="help-block error-help-block">:message</span>'); !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('unit') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                {{ Form::select('unit', $unit, null, ['class' => 'form-control select2']) }}
                                                {!! $errors->first('outlet', '<span class="help-block error-help-block">:message</span>'); !!}
                                            </div>
                                        </div>
                                        <br />
                                        ...
                                        <div class="form-group m-form__group row {{ $errors->has('cost') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                <div class="input-group">
                                                    ...
                                                    {{ Form::text('cost', '', ['class' => 'form-control', 'placeholder' => 'Cost Value']) }}
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('price') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                <div class="input-group">
                                                    <div class="input-group-append"><span class="input-group-text" id="basic-addon2">Rp</span></div>
                                                    {{ Form::text('price', '', ['class' => 'form-control', 'placeholder' => 'Price For Sale']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('storage') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                {{ Form::text('storage', '', ['class' => 'form-control']) }}
                                        ...
                                        <div class="form-group m-form__group row {{ $errors->has('release_date') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                <div class="input-group date">
                                                    {{ Form::text('release_date', '', ['class' => 'form-control m-input', 'readonly' => 'readonly', 'placeholder' => 'Date Release Product']) }}
                                    ...
                                    <div class="col-md-12 my_form">
                                        <div class="form-group m-form__group row {{ $errors->has('description') ? 'has-error' :'' }}">
                                            ...
                                            <div class="col-lg-8 col-sm-6">
                                                {{ Form::textarea('description', '', ['class' => 'form-control', 'placeholder' => 'Optional']) }}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\ProductRequest', '#product_create') !!}
        ...
        $(document).ready(function(){
            ...
            */
            $('#product_create').on('submit', function (e) {
                // form is valid
                is_form_valid = $('#product_create').valid();
