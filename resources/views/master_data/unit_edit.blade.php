        ...
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(['route' => [$route_update, $unit->id], 'id' => 'unit_edit', 'class' => 'm-form m-form--fit m-form--label-align-left']) !!}
                    {{method_field('PATCH')}}
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row {{ $errors->has('remark') ? 'has-error' :'' }}">
                                ...
                                <div class="col-lg-5 col-sm-12">
                                    {{ Form::textarea('remark', $unit->remark, ['class' => 'form-control']) }}
...
{!! JsValidator::formRequest('App\Http\Requests\master_data\UnitsRequest', '#unit_edit') !!}
